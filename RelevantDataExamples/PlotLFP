...
MainDir='E:\DataForNatProtocol\Pt01\';
target_fileLFP = [MainDir,'rawPt01.imec0.lf.bin']; %LFP, can replace this with .dat from OpenEphys
fid_source = fopen(target_fileLFP,'r');
dataLFP = fread (fid_source,[385,Inf],'int16'); %This is a matrix of channel x time, LFP
load('E:\DataForNatProtocol\Pt01\Pt01_ChannelMap.mat')
